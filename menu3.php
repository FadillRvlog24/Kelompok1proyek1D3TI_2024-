...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsFurni">
        <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
          ...
          <li class="active"><a class="nav-link" href="menu3.html">Menu</a></li>
  ...
  <div class="div">
    <div class="div-2">
      <div class="div-3">
        <div class="column">
          <img src="Playful Sandwiches Restaurant Menu Ad Instagram Post.png" alt="" width="200">
        </div>
        <div class="column-2">
          <div class="div-4">
            <div class="div-5">Burger chicken + juice</div>
            <div class="div-6">Rp.18.000</div>
            <div class="div-7">
              <?php
                // Database connection
                ...
                // Fetch product stock
                $sql = "SELECT quantity FROM products WHERE name='Burger chicken + juice'";
            ...
            <div class="div-8">
              <form action="add_to_cart.php" method="post">
                <input type="hidden" name="product_name" value="Paket menu burger chicken + juice">

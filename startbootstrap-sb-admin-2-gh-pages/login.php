                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="proses_login.php">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" name="email" aria-describedby="emailHelp" placeholder="Email kamu" value="<?php echo isset($_COOKIE['remembered_email']) ? htmlspecialchars($_COOKIE['remembered_email']) : ''; ?>" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Ingat email saya</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="register.html">Belum punya akun?, Daftar disini</a>
                                    </div>
                                </div>
                            </div>
                        </div>

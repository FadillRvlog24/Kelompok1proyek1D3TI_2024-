...
<body>
  ...
  <div class="div">
    <div class="div-2">
      <div class="div-3">
        <div class="column">
          <img src="Homemade strawberry milk.jpeg" alt="" width="300">
        </div>
        <div class="column-2">
          <div class="div-4">
            <div class="div-5">strawberry original milk</div>
            ...
            <div class="div-7">
              <?php
                ...
                // Fetch product stock
                $sql = "SELECT quantity FROM products WHERE name='strawberry original milk'";
            ...
            <div class="div-8">
              <form action="add_to_cart.php" method="post">
                <input type="hidden" name="product_name" value="strawberry original milk">

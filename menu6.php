...
<body>
  ...
  <div class="div">
    <div class="div-2">
      <div class="div-3">
        <div class="column">
          <img src="Hotdog + juice.png" alt="" width="200">
        </div>
        <div class="column-2">
          <div class="div-4">
            <div class="div-5">Hotdog + juice</div>
            <div class="div-6">Rp.15.000</div>
            <div class="div-7">
              <?php
                // Database connection
                ...
                // Fetch product stock
                $sql = "SELECT quantity FROM products WHERE name='Hotdog + juice'";
            ...
            <div class="div-8">
              <form action="add_to_cart.php" method="post">
                <input type="hidden" name="product_name" value="Cornet burger + french fries">

...
<body>
  ...
  <div class="div">
    <div class="div-2">
      <div class="div-3">
        <div class="column">
          <img src="Chicken Burger Special.jpeg" alt="" width="200">
        </div>
        <div class="column-2">
          <div class="div-4">
            <div class="div-5">Chicken burger special</div>
            <div class="div-6">Rp.16.000</div>
            <div class="div-7">
              <?php
                // Database connection
                ...
                // Fetch product stock
                $sql = "SELECT quantity FROM products WHERE name='Chicken burger special'";
            ...
            <div class="div-8">
              <form action="add_to_cart.php" method="post">
                <input type="hidden" name="product_name" value="Chicken burger special">
